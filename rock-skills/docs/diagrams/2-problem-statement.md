...
1. **MICRO → MID**: Extracted concepts enable concept-aware redundancy detection (not just text similarity), reducing false positives and improving grouping accuracy
